 ...
 * @author real1
 */
public class ErrorPersonal extends javax.swing.JFrame {

    /**
     * Creates new form Errorlogin
     */
    int x,y;
    public ErrorPersonal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        NuevoIntento = new javax.swing.JLabel();
        ...
        NuevoIntento.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        NuevoIntento.setForeground(new java.awt.Color(255, 255, 255));
        NuevoIntento.setText("Intertar nuevamente");
        NuevoIntento.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                NuevoIntentoMouseClicked(evt);
            }
        });
    ...
    private void NuevoIntentoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NuevoIntentoMouseClicked
        // TODO add your handling code here:
        PanelesPersonal abrir = new PanelesPersonal();
        abrir.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_NuevoIntentoMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ErrorPersonal().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel NuevoIntento;
